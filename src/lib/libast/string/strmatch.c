...
ptrdiff_t
strngrpmatch(const char* b, size_t z, const char* p, ssize_t* sub, ptrdiff_t n, regflags_t flags)
{
	regex_t*	re;
	ssize_t*	end;
	ptrdiff_t	i;
...
ptrdiff_t
strgrpmatch(const char* b, const char* p, ssize_t* sub, ptrdiff_t n, regflags_t flags)
{
