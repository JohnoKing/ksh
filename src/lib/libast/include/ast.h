...
extern signed_size_t	strgrpmatch(const char*, const char*, ssize_t*, signed_size_t, regflags_t);
extern signed_size_t	strngrpmatch(const char*, size_t, const char*, ssize_t*, signed_size_t, regflags_t);
extern size_t		strhash(const char*);
extern void*		strlook(const void*, size_t, const char*);
extern signed_size_t	strmatch(const char*, const char*);
