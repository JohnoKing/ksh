...
extern ptrdiff_t	strgrpmatch(const char*, const char*, ssize_t*, ptrdiff_t, regflags_t);
extern ptrdiff_t	strngrpmatch(const char*, size_t, const char*, ssize_t*, ptrdiff_t, regflags_t);
extern size_t		strhash(const char*);
extern void*		strlook(const void*, size_t, const char*);
extern ptrdiff_t	strmatch(const char*, const char*);
