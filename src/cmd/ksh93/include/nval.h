...
extern Dt_t		*nv_dict(Namval_t*) hot;
extern Sfdouble_t	nv_getn(Namval_t*, Namfun_t*);
extern Sfdouble_t	nv_getnum(Namval_t*) hot NONNULL(1);
extern char 		*nv_getv(Namval_t*, Namfun_t*);
extern char 		*nv_getval(Namval_t*);
extern Namfun_t		*nv_hasdisc(Namval_t*, const Namdisc_t*) hot;
...
extern void		nv_putval(Namval_t*,const char*,int) NONNULL(1);
...
extern Namval_t		*nv_search(const char *, Dt_t*, int) hot;
